...
Models for strategic audit cycles and intelligence metrics.
Moved from app/strategic_audit/audit_models.py
"""
...
class StrategicIntelligenceMetrics(BaseModel):
    ...
    decision_load_classification: str = "unknown"
