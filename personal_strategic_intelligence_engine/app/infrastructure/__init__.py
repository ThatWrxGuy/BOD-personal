"""External Intelligence Infrastructure Module.

This module provides integration with external intelligence services:
- OpenAI: Advanced reasoning and analysis
- OpenHands: Autonomous software engineering
- GitHub: Repository intelligence and code evolution

Usage:
    from app.infrastructure.external_intelligence import (
